...
class TestPipelineSpecificDecorators:
    ...
    def test_instrument_vision(self):
        ...
        from infrastructure.monitoring.instrumentation import instrument_vision, VisionStage
    ...
    def test_instrument_rag(self):
        ...
        from infrastructure.monitoring.instrumentation import instrument_rag, RAGStage
    ...
    def test_instrument_speech(self):
        ...
        from infrastructure.monitoring.instrumentation import instrument_speech, SpeechStage
