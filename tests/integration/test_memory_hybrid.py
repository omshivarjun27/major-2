...
from core.memory.indexer import FAISSIndexer, MockFAISSIndexer
from core.memory.ingest import MemoryIngester
from core.memory.retriever import MemoryRetriever
from core.memory.api_schema import MemoryStoreRequest, MemorySearchRequest
from core.memory.embeddings import MockTextEmbedder, MultimodalFuser, AudioEmbedder
...
async def run_test():
    ...
    logger.info(f"Search results for 'Where are my keys?':")
