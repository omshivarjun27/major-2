...
## Purpose
Module responsible for fig functionality.

## Key Files
- `block_diagram_prompt.txt`: Implementation/configuration file.
- `survey_outcomes_prompt.txt`: Implementation/configuration file.
