...
## Purpose
Module responsible for monitoring functionality.

## Key Files
- `AGENTS.md`: Implementation/configuration file.
- `collector.py`: Implementation/configuration file.
- `instrumentation.py`: Implementation/configuration file.
- `prometheus_metrics.py`: Implementation/configuration file.
