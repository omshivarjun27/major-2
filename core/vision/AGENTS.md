...
## Purpose
Module responsible for vision functionality.

## Key Files
- `AGENTS.md`: Implementation/configuration file.
- `model_download.py`: Implementation/configuration file.
- `model_loader.py`: Implementation/configuration file.
- `spatial.py`: Implementation/configuration file.
- `visual.py`: Implementation/configuration file.
